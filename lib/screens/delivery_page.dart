...
import 'package:toyproject/widgets/delivery_list.dart';
  ...
  Widget _deliveryItem(String image, String text) {
    return GestureDetector(
      ...
      child: Column(
        children: [
          Image.asset(
            '${image}${DeliveryStateController.to.isDeliveryState[text] == false ? '_off.png' : '_on.png'}',
        ...
        Padding(
          ...
          child: DropdownButton(
            ...
            style: const TextStyle(
                fontFamily: 'OneStore', color: Colors.black, fontSize: 17),
          ),
        ),
        Expanded(
          child: TextField(
            ...
            decoration: const InputDecoration(
              ...
              isDense: true,
              hintStyle: TextStyle(fontFamily: 'OneStore', color: Colors.grey),
            ),
            style: const TextStyle(fontFamily: 'OneStore', color: Colors.black),
          ),
        ),
