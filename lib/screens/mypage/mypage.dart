...
import 'package:toyproject/screens/mypage/profile.dart';
...
var localTextStyle =
    const TextStyle(fontFamily: 'OneStore', color: Colors.grey);
  ...
  Widget _manage() {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('경기도 화성 지점', style: localTextStyle),
          const Divider(
            color: Colors.grey,
          ),
          //직급
          Text('총 책임자', style: localTextStyle),
        ],
      ),
    );
  }
