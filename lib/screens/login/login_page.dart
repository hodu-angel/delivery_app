        ...
        children: [
          ...
          Align(
            ...
            child: TextButton(
                ...
                child: const Text(
                  '회원가입',
                  style: TextStyle(color: Colors.brown, fontFamily: 'OneStore'),
                )),
          ),
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: const Text('로그인 성공!', style: TextStyle(fontFamily: 'OneStore'),),
              ...
              child: const Text(
                '로그인',
                style: TextStyle(color: Colors.white, fontFamily: 'OneStore'),
              ),
            ),
          ),
        ],
